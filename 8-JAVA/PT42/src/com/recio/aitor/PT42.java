...
private static void cpu2Play(String[][] game) {
	...
	private static boolean checkEnd(String[][] game) {
		...
		boolean gameOn = true; 
		if(game[1][1]==game[1][2] && game[1][2]==game[1][3] && !game[1][1].equals(" ")) {
			if(game[1][1].equals("X"))
				System.out.println("Gana el jugador X");
			else
				System.out.println("Gane el jugador O");
			gameOn = false;
		}else if(game[2][1]==game[2][2] && game[2][2]==game[2][3] && !game[2][1].equals(" ")) {
			if(game[2][1].equals("X"))
				System.out.println("Gana el jugador X");
			else
				System.out.println("Gane el jugador O");
			gameOn = false;
		}else if(game[3][1]==game[3][2] && game[3][2]==game[1][3] && !game[3][1].equals(" ")) {
			if(game[3][1].equals("X"))
				System.out.println("Gana el jugador X");
			else
				System.out.println("Gane el jugador O");
			gameOn = false;
		}else if(game[1][1]==game[2][1] && game[2][1]==game[3][1]  && !game[1][1].equals(" ")) {
			if(game[1][1].equals("X"))
				System.out.println("Gana el jugador X");
			else
				System.out.println("Gane el jugador O");
			gameOn = false;
		}else if(game[1][2]==game[2][2] && game[2][2]==game[3][2] && !game[1][2].equals(" ")) {
			if(game[1][2].equals("X"))
				System.out.println("Gana el jugador X");
			else
				System.out.println("Gane el jugador O");
			gameOn = false;
		}else if(game[1][3]==game[2][3] && game[2][3]==game[3][3] && !game[1][3].equals(" ")) {
			if(game[1][3].equals("X"))
				System.out.println("Gana el jugador X");
			else
				System.out.println("Gane el jugador O");
			gameOn = false;
		}else if(game[1][1]==game[2][2] && game[2][2]==game[3][3] && !game[1][1].equals(" ")) {
			if(game[1][1].equals("X"))
				System.out.println("Gana el jugador X");
			else
				System.out.println("Gane el jugador O");
			gameOn = false;
		}else if(game[1][3]==game[2][3] && game[2][3]==game[3][1] && !game[1][3].equals(" ")) {
			if(game[1][1].equals("X"))
				System.out.println("Gana el jugador X");
			else
				System.out.println("Gane el jugador O");
